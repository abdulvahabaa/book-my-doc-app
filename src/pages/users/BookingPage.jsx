        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <section className="bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg border border-gray-700">
            ...
            <div className="space-y-3">
              <p className="text-lg">
                <strong>👨‍⚕️ Doctor:</strong> Dr. John Doe
              </p>
              <p className="text-lg">
              ...
              <p className="text-lg">
                <strong>⏰ Time Slot:</strong> 10:30 AM - 11:00 AM
              </p>
              <p className="text-lg">
                <strong>🏥 Consultation Center:</strong> Dr. John Doe's Clinic
              </p>
              <p className="text-lg">
          ...
          <section className="bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="flex items-center justify-between mb-6">
              {["Booking Slot", "Verification", "Payment"].map(
                (step, index) => (
                  <div
                    key={index}
                    className={`w-1/3 text-center ${
                      currentStep > index ? "text-amber-500" : "text-gray-400"
                    }`}
                  >
                    <div
                      className="w-10 h-10 mx-auto flex items-center justify-center border rounded-full transition-all duration-300"
                      style={{
                        borderColor:
                          currentStep > index ? "#FBBF24" : "#4B5563",
                      }}
                    >
                      {index + 1}
                    </div>
              ...
              <div>
                ...
                <form>
                  ...
                  <input
                    ...
                    value={patientDetails.phone2}
                    onChange={handleChange}
                    className="w-full p-2 rounded bg-gray-700 text-white mb-2"
                  />
                  <button
                    type="button"
                    className="w-full bg-amber-500 text-white py-2 mt-4 rounded-lg hover:bg-amber-600 transition"
            ...
            {currentStep === 2 && (
              <div>
                ...
                <p>
                  <strong>Phone 1:</strong> {patientDetails.phone1}
                </p>
                <p>
                  <strong>Phone 2:</strong> {patientDetails.phone2}
                </p>
                <p>
                  <strong>Price:</strong> ${patientDetails.price}
                </p>
                <button
            ...
            {currentStep === 3 && (
              <div>
                ...
                <p>
                  <strong>Total Price:</strong> ${patientDetails.price}
                </p>
